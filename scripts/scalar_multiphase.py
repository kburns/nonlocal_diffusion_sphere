...
def NLB_symbol(ell, δ):
    δ_index = lambda_table.δ.index(δ)
    return lambda_table.λ[ell, δ_index]
...
def nonlinear(state_vector, RHS, t):
    ...
    # EVALUATE T TO BOUNDARY
    rhs0['g'] = alpha * T['g'] * (1 - T['g']**2)
    rhs1['g'] = beta * T1['g'] * (1 - T1['g']**2)
    NL.pack(rhs0, rhs1)
